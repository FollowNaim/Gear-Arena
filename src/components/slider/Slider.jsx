      ...
      >
        <div className="col-span-1 py-20 md:pl-10 px-4 md:px-0">
          <h4 className="font-semibold text-3xl md:text-5xl leading-tight ">
            <SectionTitle>
              {heading} <br />{" "}
              <span className="text-[#3B82F6] block md:mt-2">{bold}</span>
            </SectionTitle>
          </h4>
          <p
        ...
        <div className="w-full h-full order-first md:order-none relative before:absolute  before:h-full  md:before:bg-gradient-to-r from-black via-black/20 to-transparent before:blur-md before:w-full before:z-50 before:-left-20 before:-top-10 overflow-hidden">
          <img
